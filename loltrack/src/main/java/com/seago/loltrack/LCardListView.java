...
public class LCardListView extends ListView implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public LCardListView(Context context) {
        super(context);
        init(null);
    }

    public LCardListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public LCardListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * @deprecated Use {@link #setOnCardClickListener(com.seago.loltrack.LCardListView.CardClickListener)} instead.
     */
    @Override
    ...
    /**
     * @deprecated Use {@link #setOnCardLongClickListener(com.seago.loltrack.LCardListView.CardLongClickListener)} instead.
     */
    @Override
    ...
    public final void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        } else if (item instanceof LCard) {
            LCard card = (LCard) item;
